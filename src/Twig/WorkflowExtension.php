...
class WorkflowExtension extends AbstractExtension
{
    ...
    public function getFunctions(): array
    {
        return array(
            ...
            new TwigFunction('workflow_all_transitions_dynamic', [$this, 'getTransitionsDynamic']),
    ...
    public function getTransitionsDynamic(object $subject, string $name = null): array
    {
        return $subject->getDefinition()->getTransitions();
    }
